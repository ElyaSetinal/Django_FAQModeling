...
class Inquiry(models.Model):
    ...
    RECEIVED = 'RP'
    RESPONSED = 'RC'
    ANSWER_CHOICES = [(REGISTERED, '문의등록'), (RECEIVED, '접수완료'), (RESPONSED, '답변완료')]
    # 3주차 과제용 상태 필드 추가 - choices 선택용 추가 필드
    ...
    #Advenced Mission
    answerstate = models.CharField(max_length=2, choices = ANSWER_CHOICES, verbose_name='상태', default = 'ER')
    # 모델 수정시 기존 데이터는 어떻게 처리할 것인지 설정해주어야 함. 따라서 default 추가
